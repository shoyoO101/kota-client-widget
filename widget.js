(function () {
  ...
  var css = [
    ...
    ".kota-widget-pill{position:relative;width:100%;text-align:left;border:1px solid var(--kota-border);border-radius:14px;padding:12px 38px 12px 14px;font-size:13px;font-weight:600;line-height:1.35;cursor:pointer;color:var(--kota-text);background:rgba(var(--kota-accent-rgb,0,102,255),.08);box-shadow:none;transition:transform .15s ease,background .15s ease,border-color .15s ease;}",
    ".kota-widget-pill::after{content:">";position:absolute;right:14px;top:50%;transform:translateY(-52%);font-size:19px;font-weight:400;color:rgb(var(--kota-accent-rgb,0,102,255));transition:transform .15s ease;}.kota-widget-pill:hover{transform:translateY(-1px);background:rgba(var(--kota-accent-rgb,0,102,255),.14);border-color:rgba(var(--kota-accent-rgb,0,102,255),.28);}.kota-widget-pill:hover::after{transform:translate(2px,-52%);}",
